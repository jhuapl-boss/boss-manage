...
def post_update(bosslet_config):
    ...
    sfn.update(bosslet_config, names.query_deletes.sfn, 'query_for_deletes.hsd')
    sfn.update(bosslet_config, names.delete_cuboid.sfn, 'delete_cuboid.hsd')
    sfn.update(bosslet_config, names.delete_experiment.sfn, 'delete_experiment.hsd')
    sfn.update(bosslet_config, names.delete_coord_frame.sfn, 'delete_coordinate_frame.hsd')
    sfn.update(bosslet_config, names.delete_collection.sfn, 'delete_collection.hsd')
    #sfn.update(bosslet_config, names.populate_upload_queue.sfn, 'populate_upload_queue.hsd')
    sfn.update(bosslet_config, names.ingest_queue_populate.sfn, 'ingest_queue_populate.hsd')
    sfn.update(bosslet_config, names.ingest_queue_upload.sfn, 'ingest_queue_upload.hsd')
    sfn.update(bosslet_config, names.volumetric_ingest_queue_upload.sfn, 'volumetric_ingest_queue_upload.hsd')
    sfn.update(bosslet_config, names.resolution_hierarchy.sfn, 'resolution_hierarchy.hsd')
    #sfn.update(bosslet_config, names.downsample_volume.sfn, 'downsample_volume.hsd')
